 ...
 */
public interface TwoDShape extends Comparable<TwoDShape> {
    ...
    List<? extends TwoDPoint> getPosition();
    ...
    class Line
    {
        private double m;
        private double b;
        public Line(TwoDPoint x1, TwoDPoint x2)
        {
            this.m = (x2.y - x1.y) / (x2.x - x1.x);
        ...
        public boolean equals(Object o)
        {
            ...
            {
                return ((Line) o).m == this.m && ((Line) o).b == this.b;
            }
        }
    }
}