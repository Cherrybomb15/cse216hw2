...
public class Ordering {
    ...
    static class XLocationShapeComparator implements Comparator<TwoDShape> {
        ...
        public int compare(TwoDShape o1, TwoDShape o2) {
            double most1 = Double.MIN_VALUE;
            double most2 = Double.MIN_VALUE;
            for (TwoDPoint a : o1.getPosition())
            {
                if (a.x > most1)
                {
                    most1 = a.x;
            ...
            for (TwoDPoint b : o2.getPosition())
            {
                if (b.x > most2)
                {
                    most2 = b.x;
            ...
            return most1 == most2 ? 0 : most1 > most2 ? 1 : -1;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        ArrayList<TwoDPoint> a = new ArrayList<TwoDPoint>();
        shapes.add(new Triangle(Arrays.asList(new TwoDPoint(0,0), new TwoDPoint(2,5), new TwoDPoint(4,0))));
        shapes.add(new Quadrilateral(Arrays.asList(new TwoDPoint(0,0), new TwoDPoint(0,5), new TwoDPoint(6,6), new TwoDPoint(6,0))));
        ...
        lst.add(new Circle(0,0 , 1));
        lst.add(new Triangle(Arrays.asList(new TwoDPoint(0,0), new TwoDPoint(2,5), new TwoDPoint(4,0))));
     ...
     */
    static <T extends TwoDShape> TwoDShape printAllAndReturnLeast(List<T> aList, AbstractPrinter aPrinter) {
        XLocationShapeComparator a = new XLocationShapeComparator();
        T least = aList.get(0);
        for (T t : aList) {
            if (a.compare( least, t) < 0)
                least = t;
            aPrinter.print(t);
        }
        return least;
